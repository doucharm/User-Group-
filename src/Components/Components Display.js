    ...
    return (
        <div>
            ...
            <table className="table table-hover table-bordered table-light table-stripped">
                <thead>
                    <tr><th>ID</th><th>Name</th><th>Surname</th><th>Email</th><th>Role</th><th>Delete</th><th>Replace</th><th>Move</th></tr>
                </thead>
                <tbody>
                    <>
            ...
            <table className="table table-hover table-bordered table-warning table-stripped table-responsive">
                <thead>
                    <tr><th>ID</th><th>Name</th><th>Type</th><th>Details</th><th>Delete</th><th>Move</th></tr>
                </thead>
                <tbody>
                    <>
    ...
    if (membership.valid) {
        return (
            <tr className="table-success" >
                <td onClick={()=>set_display_id(membership.user.id)}>{membership.user.id}</td>
                <td onClick={()=>set_display_id(membership.user.id)}>{membership.user.name}</td>
                <td onClick={()=>set_display_id(membership.user.id)}>{membership.user.surname}</td>
                <td onClick={()=>set_display_id(membership.user.id)}>{membership.user.email}</td>
