 ...
 * @param {Object} icon the icon that indicate what this button do
 * @param {Object} sec_button second state of the button
 * @returns {JSX.Element} A two-state button in html form
 */
